...
const Main = ({navigation}) => {
  ...
  useEffect(() => {
    ...
    Geolocation.getCurrentPosition(geolocation.requestAuthorization(info => console.log("geo info", info)));
    // geolocation.requestAuthorization(info => console.log("geo info", info));
