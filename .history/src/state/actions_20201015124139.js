  ...
  return (dispatch, getState) => {
    ...
    Requests.getBylocationKey(locationKey).then((res) => {
      if (res.Code) {
        ...
        setIconPath(res[0], setFavoriteCurrentWeather)
      }
    });
  }
...
export const getLocation = () => {
  ...
  Geolocation.getCurrentPosition(
    res => {
      console.log("coords", res.coords.latitude, res.coords.longitude)
      Requests.getGeoPosition(res.coords.latitude, res.coords.longitude)
    },
