...
const Main = ({navigation}) => {
  ...
  const [useGeoposition, setUseGeoposition] = useState(false);
      ...
      <SafeAreaView>
        <MainView height={height} width={width}>
          ...
          <UpperView height={height} width={width} isLandscape={isLandscape}>
            <FavoriteButton isFavorite={isFavorite} isLandscape={isLandscape} />
            <SearchBox
              ...
              width={width}
            />
            <LocationButton useGeoposition={useGeoposition} setUseGeoposition={setUseGeoposition} isLandscape={isLandscape} />
