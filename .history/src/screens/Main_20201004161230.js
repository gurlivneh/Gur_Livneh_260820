        ...
        <MainView height={height} width={width}>
          ...
          {currentWeather && forecast && !error && (
            <WeatherView>
              ...
              <WeatherRow>
                <CurrentBox
                  height={isLandscape ? height * 0.4 : height * 0.25}
                  width={isLandscape ? width * 0.15 : width * 0.9}
                  city={city}
                  currentWeather={currentWeather}
                />
                {forecast.DailyForecasts.map((item, i) => {
                  return (
                    <ForecastBox
                      key={i}
                      item={item}
                      height={isLandscape ? height * 0.4 : height * 0.15}
                      width={isLandscape ? width * 0.15 : width * 0.30}
                    />
                  );
                })}
              </WeatherRow>
