...
const FavoritesBox = (props) => {
  ...
  return (
    ...
    >
      ...
      {favoriteCurrentWeather &&  <Logo source={{ uri: `https://developer.accuweather.com/sites/default/files/${favoriteCurrentWeather.WeatherIcon < 10 ? "0"+favoriteCurrentWeather.WeatherIcon  : favoriteCurrentWeather.WeatherIcon}-s.png` }}
