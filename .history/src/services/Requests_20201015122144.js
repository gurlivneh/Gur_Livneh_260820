...
const GEOPOSITION = '/locationvs/1/cities/geoposition/search'
...
export const getAutoSearch = (lat, lon) => {
    return _request(CITY_AUTO_COMPLETE,  `&q=${lat+'%2C'+lon}`)
}

export const getGeoPosition = (keyword) => {
    return _request(GEOPOSITION,  `&q=${keyword}`)
}
