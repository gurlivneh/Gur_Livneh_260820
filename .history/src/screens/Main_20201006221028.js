            ...
            {currentWeather && forecast && !error && (
              <WeatherView isLandscape={isLandscape}>
                ...
                <WeatherRow isLandscape={isLandscape}>
                  <CurrentBox
                    height={isLandscape ? height * 0.4 : height * 0.16}
                  ...
                  {forecast.DailyForecasts.map((item, i) => {
                    return (
                      <ForecastBox
                        key={i}
                        item={item}
                        height={isLandscape ? height * 0.5 : height * 0.26}
                        width={isLandscape ? width * 0.14 : width * 0.3}
                      />
                    );
                  })}
                </WeatherRow>
...
`;
const WeatherRow = styled(ScrollView)`
  width: 100%;
